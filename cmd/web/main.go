...
func main() {
	...
	dashboardHandler := dashboard.NewHandler(reportSvc, journalSvc, templates)

	// Create router with all routes
	router := server.NewRouter(templates, accountHandler, journalHandler, reportHandler, dashboardHandler)
